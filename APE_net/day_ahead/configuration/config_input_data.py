...
NWP_DATA_MERGE = ['by_area', 'by_area_variable']  # 'all', 'by_area', 'by_area_variable', 'by_variable', 'by_horizon',
                                        # 'by_area_horizon',
                                        # by_nwp_provider

DATA_COMPRESS = ['semi_full', 'dense', 'full']  # dense or semi_full or full or load

DATA_NWP_SCALE = ['minmax', 'standard']
