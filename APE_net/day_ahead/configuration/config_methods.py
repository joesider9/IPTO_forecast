import numpy as np
from day_ahead.configuration.config_utils import define_n_jobs
from day_ahead.configuration.config_utils import define_enviroment
from day_ahead.configuration.config_project import TYPE
from day_ahead.configuration.config_project import HORIZON_TYPE
from day_ahead.configuration.experiments_base import experiments
...
def config_methods():
    ...
    static_data['val_test_ratio'] = 0.15
    ...
    static_data['clustering'] = {'n_jobs': n_jobs['n_jobs'],
                                 ...
                                 'prediction_for_method': ['RBF', 'GA'],  # RBF or GA or both
                                 'thres_act': 0.001,
