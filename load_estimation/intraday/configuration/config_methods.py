import numpy as np
from intraday.configuration.config_utils import define_n_jobs
from intraday.configuration.config_utils import define_enviroment
from intraday.configuration.config_project import TYPE
from intraday.configuration.config_project import HORIZON_TYPE
from intraday.configuration.experiments_base import experiments
...
### WARNING !!!!!!!!!!!!!!!!! PCA is commented for load estimation models. TODO Uncomment
FEATURE_SELECTION_METHODS = [None, 'lasso', 'ShapValues']  # Could be None, 'lasso','FeatureImportance', 'ShapValues'

combine_methods = ['bcp', 'elastic_net', 'kmeans', 'CatBoost']  # 'bcp', 'elastic_net', 'kmeans', 'CatBoost'
...
def rbf_variables():
    if TYPE == 'pv':
        ...
        var_imp = [['ape_net_up_max', 'pv_max', 'sp_index', 'month', 'hour']]
    elif TYPE == 'fa':
...
def config_methods():
    ...
    static_data['MLP'] = {'experiment_tag': {'mlp1', 'mlp2', 'mlp3'},
                          'n_trials': 30,
                          'hold_prob': 1,
                          'batch_size': {64, 32, 128},
                          'act_func': {'elu', 'sigmoid', 'tanh'},
    ...
    static_data['Global'] = {'experiment_tag': {'distributed_lstm1', 'distributed_mlp2'},
                             'keep_n_models': 2,
                             'n_trials': 10,
                             'hold_prob': 1,
                             ...
                             'filters': 6,
                             'conv_dim': 2,
                             'nwp_data_merge': 'by_area_variable',
                             'compress_data': 'semi_full',
                             'scale_nwp_method': 'standard',
                             'what_data': 'row_all',
                             'act_func': {'sigmoid'},
                             'max_iterations': 600,
    ...
    static_data['clustering'] = {'n_jobs': n_jobs['n_jobs'],
                                 ...
                                 'thres_act': 0.001,
                                 'Gauss_abbreviations': {'hdd_h', 'temp', 'flux', 'wind', 'temp', 'load', 'power',
                                                         'u10', 'v10' 'gb_h0'},
