...
NWP_DATA_MERGE = ['all']  # 'all', 'by_area', 'by_area_variable', 'by_variable', 'by_horizon',
                                        # 'by_area_horizon',
                                        # by_nwp_provider

DATA_COMPRESS = ['load']  # dense or semi_full or full or c
...
DATA_STRUCTURE = ['row', 'lstm'] if TYPE == 'load' else what_data + ['cnn']
...
def variables():
    if TYPE == 'pv':
        ...
        variable_list = [
            variable_wrapper('ape_net', input_type='timeseries',
                             source=os.path.join(path_data, 'ape_net.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('pv_max', input_type='timeseries',
                             source=os.path.join(path_data, 'extra_data.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('ape_net_up_max', input_type='timeseries',
                             source=os.path.join(path_data, 'extra_data.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('ape_net_fix', input_type='timeseries',
                             source=os.path.join(path_data, 'extra_data.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('pv_up', input_type='timeseries',
                             source=os.path.join(path_data, 'extra_data.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('rate_pv_cap', input_type='timeseries',
                             source=os.path.join(path_data, 'extra_data.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('ape_net_up', input_type='timeseries',
                             source=os.path.join(path_data, 'extra_data.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('load_estimation', input_type='timeseries',
                             source=os.path.join(path_data, 'extra_data.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('load_estimation_pred', input_type='timeseries',
                             source=os.path.join(path_data, 'extra_data.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('pv_rated', input_type='timeseries',
                             source=os.path.join(path_data, 'inst_cap.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('hydro_rated', input_type='timeseries',
                             source=os.path.join(path_data, 'inst_cap.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('bio_rated', input_type='timeseries',
                             source=os.path.join(path_data, 'inst_cap.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('sythia_rated', input_type='timeseries',
                             source=os.path.join(path_data, 'inst_cap.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('bio', input_type='timeseries',
                             source=os.path.join(path_data, 'res_mv_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('bio_cap', input_type='timeseries',
                             source=os.path.join(path_data, 'res_mv_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('hydro', input_type='timeseries',
                             source=os.path.join(path_data, 'res_mv_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('hydro_cap', input_type='timeseries',
                             source=os.path.join(path_data, 'res_mv_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('sithia', input_type='timeseries',
                             source=os.path.join(path_data, 'res_mv_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('sithia_cap', input_type='timeseries',
                             source=os.path.join(path_data, 'res_mv_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('pv', input_type='timeseries',
                             source=os.path.join(path_data, 'res_mv_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('pv_cap', input_type='timeseries',
                             source=os.path.join(path_data, 'res_mv_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('scada', input_type='timeseries',
                             source=os.path.join(path_data, 'scada_ts.csv'),
                             timezone=static_data['local_timezone']),
            variable_wrapper('dayweek', input_type='calendar', source='index',
                             timezone=static_data['local_timezone']),
            variable_wrapper('sp_index', input_type='calendar', source='index',
                             timezone=static_data['local_timezone']),
            variable_wrapper('hour', input_type='calendar', source='index',
                             timezone=static_data['local_timezone']),
            variable_wrapper('month', input_type='calendar', source='index',
...
def config_data():
    static_input_data = {'nwp_data_merge': NWP_DATA_MERGE if TYPE != 'load' else ['all'],
