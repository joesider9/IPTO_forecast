import numpy as np
from intra_day.configuration.config_utils import define_n_jobs
from intra_day.configuration.config_utils import define_enviroment
from intra_day.configuration.config_project import TYPE
from intra_day.configuration.config_project import HORIZON_TYPE
from intra_day.configuration.experiments_base import experiments
...
combine_methods = ['kmeans', 'CatBoost']  # 'bcp', 'elastic_net', 'kmeans', 'CatBoost'
